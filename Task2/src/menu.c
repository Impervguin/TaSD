...
void print_menu()
{
    ...
    printf("8 - Отсортитировать страны по цене путешествия без ключей.\n");
    printf("9 - Сравнить сортировку пузырьком и быструю на данной таблице данных.\n");
    printf("0 - Выход.\n");
}
...
{
    printf("------------------------------------------------------------------------\n");
    printf("Время быстрой сортировки в массиве с ключами: %ld мкс\n", qsi_t);
    printf("Время быстрой сортировки в массиве без ключей: %ld мкс\n", qsa_t);
    printf("Время сортировки выбором в массиве с ключей: %ld мкс\n", msi_t);
    printf("Время сортировки выбором в массиве без ключей: %ld мкс\n", msa_t);
    printf("------------------------------------------------------------------------\n");
    printf("Объём массива с ключами: %zu байт.\n", isize);
    printf("Объём массива без ключами: %zu байт.\n", asize);
    printf("------------------------------------------------------------------------\n");
}