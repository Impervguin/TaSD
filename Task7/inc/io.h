...
typedef enum {BADD = 1, BFIND, BDELETE, BPRINT, AVLADD, AVLFIND, AVLDELETE, AVLPRINT, HASHADD, HASHFIND, HASHDELETE, HASHRESTRUCT, HASHPRINT, CHANGE, CALC, ARRBTREE, ARRAVLTREE, ARRHASH,  COMPARE, EXIT = 0} command_t;
